...
void mc_interface_init(void) {
	...
	//commands_printf("encoder mode: %d\r\n", motor_now()->m_conf.m_sensor_port_mode);
	// Initialize encoder
	...
	case SENSOR_PORT_MODE_ICMHM_SPI:
		encoder_init_icmhm_spi();
		break;
	...
	motor_now()->m_conf.m_sensor_port_mode = SENSOR_PORT_MODE_ICMHM_SPI;
	encoder_init_icmhm_spi();
...
void mc_interface_set_configuration(mc_configuration *configuration) {
	...
	if (motor->m_conf.m_sensor_port_mode != configuration->m_sensor_port_mode) {
		...
		motor->m_conf.m_sensor_port_mode = SENSOR_PORT_MODE_ICMHM_SPI;
		encoder_init_icmhm_spi();
	}
